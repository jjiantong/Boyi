...
// OpenCL kernel ------------------------------------------------------------------------------------------
__kernel void StreamCompaction_kernel(int size, int value, __local int *l_data, __local int *l_count, int n_tasks, float alpha, 
									__global int *output, __global int *input, __global int *flags ) {
