...
__kernel void non_max_supp_kernel(__global unsigned char *data,
	...
	switch(theta[pos_0]) {
    case 0:
		index1 = l_row * (L_SIZE + 2) + l_col_0 + 1;
		index2 = l_row * (L_SIZE + 2) + l_col_0 - 1;
        break;

    case 45:
		index1 = (l_row - 1) * (L_SIZE + 2) + l_col_0 + 1;
		index2 = (l_row + 1) * (L_SIZE + 2) + l_col_0 - 1;
        break;

    case 90:
		index1 = (l_row - 1) * (L_SIZE + 2) + l_col_0;
		index2 = (l_row + 1) * (L_SIZE + 2) + l_col_0;
        break;
    ...
    if(my_magnitude_0 <= l_data[index1] || 
        my_magnitude_0 <= l_data[index2]) 
    {
        p_out_0 = 0;
    }
    else {
	...
	switch(theta[pos_1]) {
    case 0:
		index1 = l_row * (L_SIZE + 2) + l_col_1 + 1;
		index2 = l_row * (L_SIZE + 2) + l_col_1 - 1;
        break;

    case 45:
		index1 = (l_row - 1) * (L_SIZE + 2) + l_col_1 + 1;
		index2 = (l_row + 1) * (L_SIZE + 2) + l_col_1 - 1;
        break;

    case 90:
		index1 = (l_row - 1) * (L_SIZE + 2) + l_col_1;
		index2 = (l_row + 1) * (L_SIZE + 2) + l_col_1;
        break;
    ...
    if(my_magnitude_1 <= l_data[index1] || 
        my_magnitude_1 <= l_data[index2]) 
    {
        p_out_1 = 0;
    }
    else {
