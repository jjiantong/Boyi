...
void Histogram_kernel(int size, int bins, __global unsigned int *data,
    ...
    for(int i = 0; i < size2; i++) {
        ...
        unsigned int d0 = data_uint16_0.s0;
		unsigned int d1 = data_uint16_0.s1;
		unsigned int d2 = data_uint16_0.s2;
		unsigned int d3 = data_uint16_0.s3;
		unsigned int d4 = data_uint16_0.s4;
		unsigned int d5 = data_uint16_0.s5;
		unsigned int d6 = data_uint16_0.s6;
		unsigned int d7 = data_uint16_0.s7;
		unsigned int d8 = data_uint16_0.s8;
		unsigned int d9 = data_uint16_0.s9;
		unsigned int d10 = data_uint16_0.sA;
		unsigned int d11 = data_uint16_0.sB;
		unsigned int d12 = data_uint16_0.sC;
		unsigned int d13 = data_uint16_0.sD;
		unsigned int d14 = data_uint16_0.sE;
		unsigned int d15 = data_uint16_0.sF;
		unsigned int d16 = data_uint16_1.s0;
		unsigned int d17 = data_uint16_1.s1;
		unsigned int d18 = data_uint16_1.s2;
		unsigned int d19 = data_uint16_1.s3;
		unsigned int d20 = data_uint16_1.s4;
		unsigned int d21 = data_uint16_1.s5;
		unsigned int d22 = data_uint16_1.s6;
		unsigned int d23 = data_uint16_1.s7;
		unsigned int d24 = data_uint16_1.s8;
		unsigned int d25 = data_uint16_1.s9;
		unsigned int d26 = data_uint16_1.sA;
		unsigned int d27 = data_uint16_1.sB;
		unsigned int d28 = data_uint16_1.sC;
		unsigned int d29 = data_uint16_1.sD;
		unsigned int d30 = data_uint16_1.sE;
		unsigned int d31 = data_uint16_1.sF;
