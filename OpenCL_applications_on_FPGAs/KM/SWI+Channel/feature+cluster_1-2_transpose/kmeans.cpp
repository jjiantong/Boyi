...
int allocate(int n_points, int n_features, int n_clusters, float **feature)
{
	...
	// Create the program.
	std::string binary_file = getBoardBinaryFile("feature+cluster_1-2_transpose", clDeviceID);
	printf("\nUsing AOCX:%s\n",binary_file.c_str());
...
{ 
	...
	clSetKernelArg(clKernel_in, 2, sizeof(cl_int), (void*) &n_points);
	clSetKernelArg(clKernel_in, 3, sizeof(cl_int), (void*) &n_clusters);
	clSetKernelArg(clKernel_in, 4, sizeof(cl_int), (void*) &n_features);
	...
	clSetKernelArg(clKernel_0, 0, sizeof(void *), (void*) &d_membership);
	...
	clSetKernelArg(clKernel_1, 0, sizeof(void *), (void*) &d_membership);
	clSetKernelArg(clKernel_1, 1, sizeof(cl_int), (void*) &n_points);
