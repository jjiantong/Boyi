...
int allocate(int n_points, int n_features, int n_clusters, float **feature)
{
	...
	// Create the program.
	std::string binary_file = getBoardBinaryFile("1-4_transpose_uli8_ulo6", clDeviceID);
	printf("\nUsing AOCX:%s\n",binary_file.c_str());
	...
	d_distance = clCreateBuffer(clContext, CL_MEM_READ_WRITE, n_clusters * n_points * sizeof(float), NULL, 0 );
...
{ 
	...
	//clSetKernelArg(clKernel_in, 1, sizeof(void *), (void*) &d_cluster);
	//clSetKernelArg(clKernel_in, 2, sizeof(void *), (void*) &d_membership);
	//clSetKernelArg(clKernel_in, 2, sizeof(void *), (void*) &d_distance);
	clSetKernelArg(clKernel_in, 1, sizeof(cl_int), (void*) &n_points);
	//clSetKernelArg(clKernel_in, 4, sizeof(cl_int), (void*) &n_clusters);
	//clSetKernelArg(clKernel_in, 5, sizeof(cl_int), (void*) &n_features);

	size_t gs[1] = {(size_t)n_points / 4};
	size_t ls[1] = {(size_t)128}; 
	size_t ls2[1] = {(size_t)1};

	clStatus = clEnqueueNDRangeKernel(clCommandQueue_in, clKernel_in, 1, NULL, gs, ls2, 0, 0, 0);
	CL_ERR();
	...
	//clSetKernelArg(clKernel_0, 2, sizeof(void *), (void*) &d_distance);
	//clSetKernelArg(clKernel_0, 1, sizeof(cl_int), (void*) &n_points);
	clSetKernelArg(clKernel_0, 2, sizeof(cl_int), (void*) &n_clusters);
	clSetKernelArg(clKernel_0, 3, sizeof(cl_int), (void*) &n_features);

	clStatus = clEnqueueNDRangeKernel(clCommandQueue_0, clKernel_0, 1, NULL, gs, ls, 0, 0, 0);
	CL_ERR();
	...
	//clSetKernelArg(clKernel_1, 0, sizeof(void *), (void*) &d_distance);
	clSetKernelArg(clKernel_1, 1, sizeof(void *), (void*) &d_membership);
	//clSetKernelArg(clKernel_0, 2, sizeof(cl_int), (void*) &n_points);
	clSetKernelArg(clKernel_1, 2, sizeof(cl_int), (void*) &n_clusters);
	clSetKernelArg(clKernel_1, 3, sizeof(cl_int), (void*) &n_features);

	clStatus = clEnqueueNDRangeKernel(clCommandQueue_1, clKernel_1, 1, NULL, gs, ls, 0, 0, 0);
	CL_ERR();
	...
	//clSetKernelArg(clKernel_0, 2, sizeof(void *), (void*) &d_distance);
	//clSetKernelArg(clKernel_0, 1, sizeof(cl_int), (void*) &n_points);
	clSetKernelArg(clKernel_2, 2, sizeof(cl_int), (void*) &n_clusters);
	clSetKernelArg(clKernel_2, 3, sizeof(cl_int), (void*) &n_features);

	clStatus = clEnqueueNDRangeKernel(clCommandQueue_2, clKernel_2, 1, NULL, gs, ls, 0, 0, 0);
	CL_ERR();
	...
	//clSetKernelArg(clKernel_0, 2, sizeof(cl_int), (void*) &n_points);
	clSetKernelArg(clKernel_3, 2, sizeof(cl_int), (void*) &n_clusters);
	clSetKernelArg(clKernel_3, 3, sizeof(cl_int), (void*) &n_features);

	clStatus = clEnqueueNDRangeKernel(clCommandQueue_3, clKernel_3, 1, NULL, gs, ls, 0, 0, 0);
	CL_ERR();
