...
void kmeans_kernel_c(__global float  *restrict feature,   
	...
	for (int point_id = 0; point_id < npoints / 16; point_id ++) {
		...
		int point_id4  = point_id * 4 + 4;
		int point_id5  = point_id * 4 + 5;
		int point_id6  = point_id * 4 + 6;
		int point_id7  = point_id * 4 + 7;
		int point_id8  = point_id * 4 + 8;
		int point_id9  = point_id * 4 + 9;
		int point_id10 = point_id * 4 + 10;
		int point_id11 = point_id * 4 + 11;
		int point_id12 = point_id * 4 + 12;
		int point_id13 = point_id * 4 + 13;
		int point_id14 = point_id * 4 + 14;
		int point_id15 = point_id * 4 + 15;
		...
		p_feature8[0] = feature[0 * npoints + point_id8];
		p_feature8[1] = feature[1 * npoints + point_id8];
		p_feature8[2] = feature[2 * npoints + point_id8];
		p_feature8[3] = feature[3 * npoints + point_id8];
		p_feature8[4] = feature[4 * npoints + point_id8];
		p_feature8[5] = feature[5 * npoints + point_id8];
		p_feature8[6] = feature[6 * npoints + point_id8];
		p_feature8[7] = feature[7 * npoints + point_id8];

		p_feature9[0] = feature[0 * npoints + point_id9];
		p_feature9[1] = feature[1 * npoints + point_id9];
		p_feature9[2] = feature[2 * npoints + point_id9];
		p_feature9[3] = feature[3 * npoints + point_id9];
		p_feature9[4] = feature[4 * npoints + point_id9];
		p_feature9[5] = feature[5 * npoints + point_id9];
		p_feature9[6] = feature[6 * npoints + point_id9];
		p_feature9[7] = feature[7 * npoints + point_id9];

		p_feature10[0] = feature[0 * npoints + point_id10];
		p_feature10[1] = feature[1 * npoints + point_id10];
		p_feature10[2] = feature[2 * npoints + point_id10];
		p_feature10[3] = feature[3 * npoints + point_id10];
		p_feature10[4] = feature[4 * npoints + point_id10];
		p_feature10[5] = feature[5 * npoints + point_id10];
		p_feature10[6] = feature[6 * npoints + point_id10];
		p_feature10[7] = feature[7 * npoints + point_id10];

		p_feature11[0] = feature[0 * npoints + point_id11];
		p_feature11[1] = feature[1 * npoints + point_id11];
		p_feature11[2] = feature[2 * npoints + point_id11];
		p_feature11[3] = feature[3 * npoints + point_id11];
		p_feature11[4] = feature[4 * npoints + point_id11];
		p_feature11[5] = feature[5 * npoints + point_id11];
		p_feature11[6] = feature[6 * npoints + point_id11];
		p_feature11[7] = feature[7 * npoints + point_id11];

		p_feature12[0] = feature[0 * npoints + point_id12];
		p_feature12[1] = feature[1 * npoints + point_id12];
		p_feature12[2] = feature[2 * npoints + point_id12];
		p_feature12[3] = feature[3 * npoints + point_id12];
		p_feature12[4] = feature[4 * npoints + point_id12];
		p_feature12[5] = feature[5 * npoints + point_id12];
		p_feature12[6] = feature[6 * npoints + point_id12];
		p_feature12[7] = feature[7 * npoints + point_id12];

		p_feature13[0] = feature[0 * npoints + point_id13];
		p_feature13[1] = feature[1 * npoints + point_id13];
		p_feature13[2] = feature[2 * npoints + point_id13];
		p_feature13[3] = feature[3 * npoints + point_id13];
		p_feature13[4] = feature[4 * npoints + point_id13];
		p_feature13[5] = feature[5 * npoints + point_id13];
		p_feature13[6] = feature[6 * npoints + point_id13];
		p_feature13[7] = feature[7 * npoints + point_id13];

		p_feature14[0] = feature[0 * npoints + point_id14];
		p_feature14[1] = feature[1 * npoints + point_id14];
		p_feature14[2] = feature[2 * npoints + point_id14];
		p_feature14[3] = feature[3 * npoints + point_id14];
		p_feature14[4] = feature[4 * npoints + point_id14];
		p_feature14[5] = feature[5 * npoints + point_id14];
		p_feature14[6] = feature[6 * npoints + point_id14];
		p_feature14[7] = feature[7 * npoints + point_id14];

		p_feature15[0] = feature[0 * npoints + point_id15];
		p_feature15[1] = feature[1 * npoints + point_id15];
		p_feature15[2] = feature[2 * npoints + point_id15];
		p_feature15[3] = feature[3 * npoints + point_id15];
		p_feature15[4] = feature[4 * npoints + point_id15];
		p_feature15[5] = feature[5 * npoints + point_id15];
		p_feature15[6] = feature[6 * npoints + point_id15];
		p_feature15[7] = feature[7 * npoints + point_id15];
