    ...
    proxy_threads.push_back(std::thread([&, proxy_tid]() {
        ...
        for(int task_id = 0; task_id < n_frames; task_id ++) {
            ...
            clStatus = clEnqueueTask(
                ocl.clCommandQueue1, ocl.clKernel_gauss, 0, NULL, NULL);
            CL_ERR();
            ...
            // Kernel launch
            clStatus = clEnqueueTask(
                ocl.clCommandQueue2, ocl.clKernel_sobel, 0, NULL, NULL);
            CL_ERR();
            ...
            // Kernel launch
            clStatus = clEnqueueTask(
                ocl.clCommandQueue3, ocl.clKernel_nonmax, 0, NULL, NULL);
            CL_ERR();
            ...
            // Kernel launch
            clStatus =
                clEnqueueTask(ocl.clCommandQueue4, ocl.clKernel_hyst, 0, NULL, NULL);
            CL_ERR();
