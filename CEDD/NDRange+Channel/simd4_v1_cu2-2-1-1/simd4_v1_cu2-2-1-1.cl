...
__kernel void non_max_supp_kernel(__global unsigned char *data,
    ...
    const int g_row_0 = get_global_id(1) * 2 + 0;
	const int g_row_1 = get_global_id(1) * 2 + 1;
    const int g_col_0 = get_global_id(0) * 2 + 0;
	const int g_col_1 = get_global_id(0) * 2 + 1;
    const int l_row_0 = get_local_id(1) * 2 + 0 + 1;
	const int l_row_1 = get_local_id(1) * 2 + 1 + 1;
    const int l_col_0 = get_local_id(0) * 2 + 0 + 1;
	const int l_col_1 = get_local_id(0) * 2 + 1 + 1;

    const int pos_0   = g_row_0 * cols + g_col_0;
	const int pos_1   = g_row_0 * cols + g_col_1;
	const int pos_2   = g_row_1 * cols + g_col_0;
	const int pos_3   = g_row_1 * cols + g_col_1;


    l_data[l_row_0 * (L_SIZE + 2) + l_col_0] = data[pos_0];
	l_data[l_row_0 * (L_SIZE + 2) + l_col_1] = data[pos_1];
	l_data[l_row_1 * (L_SIZE + 2) + l_col_0] = data[pos_2];
	l_data[l_row_1 * (L_SIZE + 2) + l_col_1] = data[pos_3];
    ...
    else if(l_row_1 == L_SIZE) {
        l_data[(L_SIZE + 1) * (L_SIZE + 2) + l_col_0] = data[pos_2 + cols];
		l_data[(L_SIZE + 1) * (L_SIZE + 2) + l_col_1] = data[pos_3 + cols];

        if(l_col_0 == 1)
            l_data[(L_SIZE + 1) * (L_SIZE + 2) + 0] = data[pos_2 + cols - 1];
    ...
    if(l_col_0 == 1) {
		...
		l_data[l_row_1 * (L_SIZE + 2) + 0] = data[pos_2 - 1];
    }
	else if(l_col_1 == L_SIZE) {
        l_data[l_row_0 * (L_SIZE + 2) + (L_SIZE + 1)] = data[pos_1 + 1];
		l_data[l_row_1 * (L_SIZE + 2) + (L_SIZE + 1)] = data[pos_3 + 1];
	}
    ...
    unsigned char my_magnitude_0 = l_data[l_row_0 * (L_SIZE + 2) + l_col_0];    
	unsigned char my_magnitude_1 = l_data[l_row_0 * (L_SIZE + 2) + l_col_1]; 
    unsigned char my_magnitude_2 = l_data[l_row_1 * (L_SIZE + 2) + l_col_0];    
	unsigned char my_magnitude_3 = l_data[l_row_1 * (L_SIZE + 2) + l_col_1]; 
	...
	switch(theta[pos_0]) {
    case 0:
        if(my_magnitude_0 <= l_data[l_row_0 * (L_SIZE + 2) + l_col_0 + 1] || // east
            my_magnitude_0 <= l_data[l_row_0 * (L_SIZE + 2) + l_col_0 - 1]) // west
            p_out_0 = 0;
        else 
    ...
    case 45:
        if(my_magnitude_0 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_0 + 1] || // north east
            my_magnitude_0 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_0 - 1]) // south west
            p_out_0 = 0;
        else 
            p_out_0 = my_magnitude_0;
        break;
    ...
    case 90:
        if(my_magnitude_0 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_0] || // north
            my_magnitude_0 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_0]) // south
            p_out_0 = 0;
        else 
            p_out_0 = my_magnitude_0;
        break;
    ...
    case 135:
        if(my_magnitude_0 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_0 - 1] || // north west
            my_magnitude_0 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_0 + 1]) // south east
            p_out_0 = 0;
        else 
            p_out_0 = my_magnitude_0;
        break;
	...
	switch(theta[pos_1]) {
    case 0:
        if(my_magnitude_1 <= l_data[l_row_0 * (L_SIZE + 2) + l_col_1 + 1] || // east
            my_magnitude_1 <= l_data[l_row_0 * (L_SIZE + 2) + l_col_1 - 1]) // west
            p_out_1 = 0;
        else 
    ...
    case 45:
        if(my_magnitude_1 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_1 + 1] || // north east
            my_magnitude_1 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_1 - 1]) // south west
            p_out_1 = 0;
        else 
            p_out_1 = my_magnitude_1;
        break;
    ...
    case 90:
        if(my_magnitude_1 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_1] || // north
            my_magnitude_1 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_1]) // south
            p_out_1 = 0;
        else 
            p_out_1 = my_magnitude_1;
        break;
    ...
    case 135:
        if(my_magnitude_1 <= l_data[(l_row_0 - 1) * (L_SIZE + 2) + l_col_1 - 1] || // north west
            my_magnitude_1 <= l_data[(l_row_0 + 1) * (L_SIZE + 2) + l_col_1 + 1]) // south east
            p_out_1 = 0;
        else 
            p_out_1 = my_magnitude_1;
        break;
	...
	switch(theta[pos_2]) {
    case 0:
        if(my_magnitude_2 <= l_data[l_row_1 * (L_SIZE + 2) + l_col_0 + 1] || // east
            my_magnitude_2 <= l_data[l_row_1 * (L_SIZE + 2) + l_col_0 - 1]) // west
            p_out_2 = 0;
        else 
    ...
    case 45:
        if(my_magnitude_2 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_0 + 1] || // north east
            my_magnitude_2 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_0 - 1]) // south west
            p_out_2 = 0;
        else 
            p_out_2 = my_magnitude_2;
        break;
    ...
    case 90:
        if(my_magnitude_2 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_0] || // north
            my_magnitude_2 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_0]) // south
            p_out_2 = 0;
        else 
            p_out_2 = my_magnitude_2;
        break;
    ...
    case 135:
        if(my_magnitude_2 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_0 - 1] || // north west
            my_magnitude_2 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_0 + 1]) // south east
            p_out_2 = 0;
        else 
            p_out_2 = my_magnitude_2;
        break;
	...
	switch(theta[pos_3]) {
    case 0:
        if(my_magnitude_3 <= l_data[l_row_1 * (L_SIZE + 2) + l_col_1 + 1] || // east
            my_magnitude_3 <= l_data[l_row_1 * (L_SIZE + 2) + l_col_1 - 1]) // west
            p_out_3 = 0;
        else 
    ...
    case 45:
        if(my_magnitude_3 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_1 + 1] || // north east
            my_magnitude_3 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_1 - 1]) // south west
            p_out_3 = 0;
        else 
            p_out_3 = my_magnitude_3;
        break;
    ...
    case 90:
        if(my_magnitude_3 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_1] || // north
            my_magnitude_3 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_1]) // south
            p_out_3 = 0;
        else 
            p_out_3 = my_magnitude_3;
        break;
    ...
    case 135:
        if(my_magnitude_3 <= l_data[(l_row_1 - 1) * (L_SIZE + 2) + l_col_1 - 1] || // north west
            my_magnitude_3 <= l_data[(l_row_1 + 1) * (L_SIZE + 2) + l_col_1 + 1]) // south east
            p_out_3 = 0;
        else 
            p_out_3 = my_magnitude_3;
        break;
